class NotificationsContainer extends React.Component {
  ...
  render () {
    return (
      <div className='notification-container'>
        ...
        >
          <span className='dropdown-arrow-top' />
          <span className='dropdown-arrow-bottom' />
          <div className='notification-header'>
            <span>Notifications</span>
            <a className='pull-right mark-all-as-read' onClick={e => this.handleMarkAllAsRead(e)}>
              Mark All as Read
            </a>
          </div>
          <ul
  ...
  renderNotificationIcon () {
    if (this.state.newNotificationCount > 0) {
      ...
      return <i className='fa fa-bell-o notification-bell' id='bell' />
    }
  }
    ...
    if (!this.state.notifications.length) {
      return (
        <div className='no-notifications'>
          ...
          <span className='speech-arrow-top' />
          <span className='speech-arrow-bottom' />
